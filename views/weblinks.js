...
<body>
    <div class="content-wrapper">
        ...
        <ul class="nav nav-tabs justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/weblinks">Web-Links</a>
            </li>
            <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <form action="/weblinks/create" method="POST">
                                <div class="mb-3">
                    ...
                    <div class="mt-5">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <form class="d-flex" action="/weblinks" method="GET">
                                    ...
                                    <div class="col">
                                        <div class="card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <a href="/weblinks/edit/<%= weblink.id %>" class="btn btn-sm btn-outline-primary me-2">
