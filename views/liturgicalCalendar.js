            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-4">
                        ...
                        <div class="card-body">
                            <form action="/liturgicalCalendar" method="GET" class="row g-2 align-items-end">
                                <div class="col-md-8">
                                    ...
                                    <input type="date" class="form-control date-picker" id="date-input" name="date" required value="<%= typeof info !== 'undefined' && info && info.date ? info.date : new Date().toISOString().slice(0, 10) %>">
                                </div>
                                <div class="col-md-4">
                    ...
                    <% if (info) { %>
                        <div class="card shadow-sm liturgical-card">
                            <div class="card-header bg-primary text-white">
                                <i class="fas fa-church me-2"></i>Liturgical Details for <%= info.date %>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-lg-7 mb-4">
                    ...
                    <div class="card shadow-sm reflection-card mb-4">
                        <div class="card-header bg-primary text-white">
                            <i class="fas fa-pen me-2"></i>Your Daily Reflection for <%= typeof info !== 'undefined' && info && info.date ? info.date : 'Today' %>
                        </div>
                        <div class="card-body">
                            <form id="addReflectionForm" action="/liturgicalCalendar/reflect" method="POST">
                                <input type="hidden" name="date" value="<%= typeof info !== 'undefined' && info && info.date ? info.date : new Date().toISOString().slice(0, 10) %>">
                                <div class="mb-3">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h3><i class="fas fa-calendar-day me-2 text-primary-color"></i>Reflections for <%= typeof info !== 'undefined' && info && info.date ? info.date : 'Today' %></h3>
                        </div>
                                        ...
                                        <div class="card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-end mt-3">
                                                    <a href="/liturgicalCalendar/reflect/edit/<%= reflection.id %>" class="btn btn-sm btn-outline-primary me-2">
                                                        <i class="fas fa-edit me-1"></i>Edit
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-outline-danger delete-reflection-btn" data-id="<%= reflection.id %>" data-date="<%= reflection.date.toDate().toISOString().slice(0, 10) %>">
